...
Originally built for **Delta College**. Must be pasted into a **Custom Widget** on a **course homepage** or **globally** in Widgets (not a Content topic), because it depends on Brightspace replace strings and the **Custom Widget Data API**.
